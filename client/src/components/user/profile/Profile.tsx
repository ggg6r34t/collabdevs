      ...
      <div className="p-6">
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-700">
            ...
            craft elegant code and build innovative solutions. 💻 🌍 I thrive in
            the world of web development, with expertise in front-end
            technologies like React, Vue, and Tailwind CSS. I love creating
            beautiful, user-friendly interfaces that make a difference. 🧠 When
            I'm not coding, you'll find me exploring new technologies, reading
            tech blogs, and contributing to open-source projects. I'm a lifelong
            learner, always seeking to expand my knowledge and skills. 🎮
            Outside of the digital realm, I'm an avid gamer, a coffee enthusiast
            ☕, and a nature lover 🌿. I believe in work-life balance and
            finding inspiration in both pixels and the great outdoors. Let's
            connect, collaborate, and make magic in the world of code! 🚀
            #DevLife #CodingIsArt
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select id="theme-preferences" className="border rounded-md p-2">
